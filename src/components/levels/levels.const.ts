export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    hint: 'Essen',
    cards: [
      { id: 1, word: 'Pizza', isCorrect: true },
      { id: 1, word: 'Stuhl', isCorrect: false },
      { id: 1, word: 'Apfel', isCorrect: true },
      { id: 1, word: 'Auto', isCorrect: false },
      { id: 1, word: 'Käse', isCorrect: true },
      { id: 1, word: 'Lampe', isCorrect: false },
      { id: 1, word: 'Schlüssel', isCorrect: false },
      { id: 1, word: 'Schuhe', isCorrect: false },
      { id: 1, word: 'Stein', isCorrect: false },
    ],
  },
  {
    id: 987654,
    hint: 'Technologie',
    cards: [
      { id: 1, word: 'Smartphone', isCorrect: true },
      { id: 1, word: 'Buch', isCorrect: false },
      { id: 1, word: 'Computer', isCorrect: true },
      { id: 1, word: 'Apfel', isCorrect: false },
      { id: 1, word: 'Internet', isCorrect: true },
      { id: 1, word: 'Blume', isCorrect: false },
      { id: 1, word: 'Bleistift', isCorrect: false },
      { id: 1, word: 'Baum', isCorrect: false },
      { id: 1, word: 'Gitarre', isCorrect: false },
    ],
  },
  {
    id: 76545678,
    hint: 'Natur',
    cards: [
      { id: 1, word: 'Sonne', isCorrect: true },
      { id: 1, word: 'Computer', isCorrect: false },
      { id: 1, word: 'Baum', isCorrect: true },
      { id: 1, word: 'Kaffeetasse', isCorrect: false },
      { id: 1, word: 'Fluss', isCorrect: true },
      { id: 1, word: 'Fahrrad', isCorrect: false },
      { id: 1, word: 'Pizza', isCorrect: false },
      { id: 1, word: 'Wald', isCorrect: false },
      { id: 1, word: 'Lampe', isCorrect: false },
    ],
  },
];
